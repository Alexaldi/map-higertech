            ...
            <div
                ...
                <div>
                    ...
                    <div
                        ...
                        <img src="{{ asset('images/products/hg-log900.png') }}" alt="Data Logger Multi Sensor HG-LOG900"
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/products/ews.png') }}" alt="EWS Dam Alarm System Higertech"
                                class="max-h-full max-w-full object-contain drop-shadow-md group-hover:scale-110 transition duration-300"
                                loading="lazy">
                        </div>
                        <div class="text-right text-[11px] font-mono space-y-0.5 flex-1">
