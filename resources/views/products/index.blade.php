        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-8 items-center">
            ...
            <div class="space-y-6 scroll-reveal">
                <h1
                    ...
                    Produk & Layanan Teknologi Higertech<br>
                </h1>

                <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-xl leading-relaxed">
                    Beragam solusi digital untuk kebutuhan monitoring, manajemen data, 
                    dan sistem informasi — dirancang untuk mendukung pengambilan 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
            ...
            @if ($selectedCategory && $selectedCategory->description)
                <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed mt-4">
